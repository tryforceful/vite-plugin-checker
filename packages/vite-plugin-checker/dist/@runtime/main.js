  ...
  const unmount = (vnode, parentComponent, parentSuspense, doRemove = false, optimized = false) => {
    ...
    if (shapeFlag & 6) {
      if (vnode.component.isCEChild && vnode.component.removeCEChildStyle) {
        vnode.component.removeCEChildStyle(vnode.component.type.styles, vnode.component.uid)
      }
...
function cloneVNode(vnode, extraProps, mergeRef = false, cloneTransition = false) {
  ...
  const cloned = {
    ...
    children:
      !!(process.env.NODE_ENV !== 'production') && patchFlag === -1 && isArray(children)
    ...
    if (styles) {
      ...
      styles.forEach((css, index) => {
        ...
        if (this._childStylesAnchor) {
          this.shadowRoot.insertBefore(s, this._childStylesAnchor.nextSibling)
        } else {
          this.shadowRoot.appendChild(s)
        }
        this._childStylesAnchor = s
        ...
        createElementBlock(
          ...
          [
            _ctx.collapsed
              ...
              : (openBlock(), createElementBlock('span', _hoisted_5$1, 'Close')),
          ],
          6
        )
      )
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const file = computed(() => {
      var _a
      return (
        ((_a = diagnostic.loc) == null ? void 0 : _a.file) ||
        diagnostic.id ||
        'unknown file'
      ).split(`?`)
    }).value[0]
    ...
    return (_ctx, _cache) => {
      return (
        openBlock(),
        createElementBlock('li', _hoisted_1$1, [
          createBaseVNode('pre', _hoisted_2, [
            ...
            createBaseVNode(
              ...
              toDisplayString(`[${_ctx.diagnostic.checkerId}]`) + ' ',
              5
            ),
            createBaseVNode(
              'span',
              ...
              toDisplayString(_ctx.diagnostic.message),
              3
            ),
            createTextVNode('\n  '),
          ]),
          createBaseVNode('pre', _hoisted_3, [
            createBaseVNode(
              ...
              toDisplayString(errorSource.value.textContent),
              1
            ),
          ]),
          hasFrame.value
            ? (openBlock(),
              createElementBlock('pre', _hoisted_4, [
        ...
        createElementBlock(
          ...
          [
            ...
            createElementBlock(
              Fragment,
              null,
              renderList(_ctx.checkerResults, (checkerResult, index) => {
                return (
                  openBlock(),
                  createElementBlock('li', { key: index }, [
                    createVNode(
                      Checker,
                      {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const initialCollapsed = ref(
      ((_a = props == null ? void 0 : props.overlayConfig) == null ? void 0 : _a.initialIsOpen) ===
        false ||
        ((_b = props == null ? void 0 : props.overlayConfig) == null
          ? void 0
          : _b.initialIsOpen) === 'error'
    )
    if (
      ((_c = props == null ? void 0 : props.overlayConfig) == null ? void 0 : _c.initialIsOpen) ===
      'error'
    ) {
          ...
          createElementBlock(
            ...
            [
              createVNode(
                ...
                null,
                8,
                ['collapsed', 'checker-results', 'position', 'badgeStyle']
              ),
              createBaseVNode(
                'main',
                {
                  ...
                  style: normalizeStyle(
                    (_a2 = _ctx.overlayConfig) == null ? void 0 : _a2.panelStyle
                  ),
                },
                [
