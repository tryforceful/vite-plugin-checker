    ...
    async configureServer({ root }) {
      ...
      const reportDiagnostic = (diagnostic) => {
        ...
        logChunk +=
          ...
          (0, import_logger.diagnosticToTerminalLog)(normalizedDiagnostic, 'vue-tsc')
      }
      const reportWatchStatusChanged = (diagnostic, newLine, options, errorCount) => {
        ...
        switch (diagnostic.code) {
          ...
          case 6194:
            if (overlay) {
              ;(_a = import_worker_threads.parentPort) == null
                ? void 0
                : _a.postMessage({
        ...
        ;(0, import_logger.ensureCall)(() => {
          ...
          if (terminal) {
            logChunk =
              logChunk +
              import_os.default.EOL +
              (0, import_logger.wrapCheckerSummary)('vue-tsc', diagnostic.messageText.toString())
