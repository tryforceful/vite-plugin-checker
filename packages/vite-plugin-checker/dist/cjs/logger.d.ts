...
declare function filterLogLevel(
...
declare function diagnosticToTerminalLog(
...
declare function diagnosticToRuntimeError(d: NormalizedDiagnostic[]): DiagnosticToRuntime[]
declare function toClientPayload(
  id: string,
...
declare function composeCheckerSummary(
  checkerName: string,
  errorCount: number,
  warningCount: number
): string
declare function normalizeTsDiagnostic(d: Diagnostic): NormalizedDiagnostic
declare function normalizeLspDiagnostic({
  diagnostic,
  absFilePath,
  fileText,
}: {
...
declare function normalizePublishDiagnosticParams(
...
declare function normalizeStylelintDiagnostic(
  diagnostic: Stylelint__default.LintResult
): NormalizedDiagnostic[]
