...
var _a
const URI =
  ((_a = _vscodeUri == null ? void 0 : _vscodeUri.default) == null ? void 0 : _a.URI) ??
  _vscodeUri.URI
...
function diagnosticToTerminalLog(d, name) {
  ...
  const position = d.loc
    ? import_chalk.default.yellow(d.loc.start.line) +
      ':' +
      import_chalk.default.yellow(d.loc.start.column)
    : ''
  return [
    ...
    return {
      ...
      stack:
        typeof d.stack === 'string'
          ...
          ? d.stack.join(import_os.default.EOL)
          : '',
      id: d.id,
...
function normalizeTsDiagnostic(d) {
  ...
  const pos =
    d.start === void 0
      ? null
      : (_c = (_b = d.file) == null ? void 0 : _b.getLineAndCharacterOfPosition) == null
      ? void 0
      : _c.call(_b, d.start)
