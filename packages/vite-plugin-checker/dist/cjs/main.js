...
const buildInCheckerKeys = ['typescript', 'vueTsc', 'vls', 'eslint', 'stylelint']
...
function checker(userConfig) {
  ...
  const overlayConfig =
    typeof (userConfig == null ? void 0 : userConfig.overlay) === 'object'
      ? userConfig == null
        ? void 0
        : userConfig.overlay
      : {}
  ...
  return {
    ...
    resolveId(id) {
      if (
        id === import_client.RUNTIME_CLIENT_RUNTIME_PATH ||
        id === import_client.RUNTIME_CLIENT_ENTRY_PATH
      ) {
